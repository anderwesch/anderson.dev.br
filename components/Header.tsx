  ...
  return (
    <>
      <header
        ...
        } top-0 z-30 flex items-center justify-between py-3 bg-white bg-opacity-30 backdrop-blur-lg firefox:bg-opacity-100 dark:bg-opacity-30 dark:firefox:bg-opacity-100`}
      >
